...
namespace Myspace
{
    static class Levels
    {
        ...
        public static bool level(int countLevel, Hero? player)
        {
        ...
        public static bool level1(Hero? player)
        {
        ...
        public static bool level2(Hero? player)
        {
            Round roundPlayer = new();
            Round roundBot = new();
        ...
        public static bool level3(Hero? player)
        {
            Round roundPlayer = new();
            Round roundBot = new();
        ...
        public static bool level4(Hero? player)
        {
            Round roundPlayer = new();
            Round roundBot1 = new();
            Round roundBot2 = new();
