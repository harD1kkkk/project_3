namespace Myspace
{
    static class PrintManager
    {
        ...
        {
            Console.WriteLine($"Bot1 {bot1.Name} attacks {bot2.Name} for {damageDealt} damage.");
            Console.WriteLine($"{bot2.Name} Health {bot2.Health}");
        }

        public static void printAttackBot2(Hero bot1, Hero bot2, double damageDealt)
        {
            Console.WriteLine($"Bot2 {bot2.Name} attacks {bot1.Name} for {damageDealt} damage.");
            Console.WriteLine($"{bot1.Name} Health {bot1.Health}");
        }
        ...
        public static void printWinnerBotvsBot(Hero bot1, Hero bot2, Round roundBot1, Round roundBot2)
        {
            if (bot2.Health <= 0)
            {
                Console.WriteLine($"Bot1: has won the battle! with character {bot1.Name}");
                Console.WriteLine($"All Physical Damage: {roundBot1.PhysicalDamage} All Magical Damage {roundBot1.MagicDamage}");

                Console.WriteLine($"Bot2: All Physical Damage: {roundBot2.PhysicalDamage} All Magical Damage {roundBot2.MagicDamage}");
            }
            else if (bot1.Health <= 0)
            {
                Console.WriteLine($"Bot2: has won the battle! with character {bot2.Name}");
                Console.WriteLine($"All Physical Damage: {roundBot2.PhysicalDamage} All Magical Damage {roundBot2.MagicDamage}");

                Console.WriteLine($"Bot1: All Physical Damage: {roundBot1.PhysicalDamage} All Magical Damage {roundBot1.MagicDamage}");
            }
        }
        ...
        public static void printWinnerPlayerWithBotAndBot(Hero player, Hero bot1, Hero bot2, Round roundPlayer, Round roundBot1,Round roundBot2)
        {
            if (player.Health <= 0)
            {
                Console.WriteLine($"Bots: have won the battle! with characters:Bot1: {bot1.Name}, Bot2: {bot2.Name}");
                Console.WriteLine($"All Physical Damage Bot1: {roundBot1.PhysicalDamage} All Magical Damage Bot1: {roundBot1.MagicDamage}, All Physical Damage Bot2: {roundBot2.PhysicalDamage} All Magical Damage Bot2: {roundBot2.MagicDamage}");
